...
import es.caib.plabedu.service.exception.ServiceException;
    ...
    public static JavaArchive createDeployment() {
        try {
            JavaArchive jar = ShrinkWrap.create(JavaArchive.class, "test.jar")
                    .addPackages(true, "es.caib.plabedu.ejb")
                    .addPackages(true, "es.caib.plabedu.persistence")
                    .addPackages(true, "es.caib.plabedu.service")
                    .addAsResource(
