...
import es.caib.plabedu.service.model.EstatPublicacio;
 ...
 */
@Entity
@SequenceGenerator(name = "uo-sequence", sequenceName = "PLE_UNITATORGANICA_SEQ", allocationSize = 1)
@Table(name = "PLE_UNITATORGANICA",
        uniqueConstraints = {
                @UniqueConstraint(name = "PLE_UNITAT_CODIDIR3_UK", columnNames = "CODIDIR3")
        },
        indexes = {
                @Index(name = "PLE_UNITAT_PK_I", columnList = "ID"),
                @Index(name = "PLE_UNITAT_CODIDIR3_UK_I", columnList = "CODIDIR3")
        }
)
@NamedQueries({
